        ...
        <Container maxWidth="fixed" sx={{justifyContent:'center'}} className="meteor-bg">
            <Grid container sx={{mt:5}}>
                ...
                <Grid item xs={12} md={6} sx={{border:'1.2px solid var(--gray)', p:2, borderRadius:'0.4em'}}>
                    <Typography variant="h5" sx={{fontFamily:'var(--displayFont)', fontWeight:800, display:{xs:'none',md:'block'}}}><img src={logo} style={{width:'4%'}} />Pragati</Typography>
                    <Typography variant="h5" sx={{fontFamily:'var(--displayFont)', fontWeight:800, display:{xs:'block',md:'none'}}}><img src={logo} style={{width:'7%'}} />Pragati</Typography>

                    <Typography sx={{mt:1}}><b>Description:</b> A website for searching cheap domestic flights in India.</Typography>
                    {/* <Typography><b>Github Repository:</b> <a href="https://github.com/ManavMehta-Official/SkyClub" target="_blank" rel="noreferrer" style={{color:'var(--indigo)'}}>Pragati</a></Typography>
